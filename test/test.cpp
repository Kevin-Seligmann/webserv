...
std::vector<RequestParseTest> create_test_suite()
{
    std::vector<RequestParseTest> tests;
...
void run_request_parsing_test(RequestParseTest test)
{
    bool ok = true;
...
void test_request_parsing()
{
    ...
    std::vector<RequestParseTest> test = create_test_suite();

    for (std::vector<RequestParseTest>::const_iterator it = test.begin(); it != test.end(); it ++)
