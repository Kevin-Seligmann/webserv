...
public:
    bool error() const;
    void reset();
    void put_error(std::string const & what, std::string const & line, std::string::const_iterator place,Status type);
    void put_error(std::string const & what, Status type);
